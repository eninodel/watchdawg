...
export default function App() {
  ...
  return (
    <View
      ...
      <Text>We will practice sending a notificaiton</Text>
...
// Used to get permissions for notifications from the device
// Only needs to be done once for each load of the app
